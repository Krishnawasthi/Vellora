...
export const StoryDetailPage: React.FC = () => {
  ...
  return (
    <article className="min-h-screen pb-24 space-y-8 max-w-2xl mx-auto px-4 sm:px-6 pt-6">
      ...
      <header className="space-y-4 text-center">
        ...
        {/* Metadata */}
        <div className="flex items-center justify-center gap-2.5 text-xs text-chocolate-700 dark:text-cream-300 font-serif italic pt-1">
      ...
      {/* Compact Featured Image Banner */}
      {story.featuredImage && (
        <div className="w-full max-w-md mx-auto">
          <div className="relative h-48 sm:h-56 rounded-2xl overflow-hidden shadow-md border border-cream-300 dark:border-chocolate-800">
            <img
      ...
      <div className={`py-4 text-chocolate-950 dark:text-cream-50 ${fontClass}`}>
        ...
        {/* Render Rich HTML Content with Compact Image Sizing */}
        <div 
